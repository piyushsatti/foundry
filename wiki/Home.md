...
## Plugins — the built products

- **[manifold](plugins/manifold/overview.md)** — the DB-canonical project compass.
- **[crucible](plugins/crucible/overview.md)** — the lens × stance code-review system.
